...
from snowman_teste.models import TourPoint, Authenticator, Session
from snowman_teste.schemas import AuthenticatorSchema

CRUD = api_crud(Authenticator, AuthenticatorSchema)


class AuthenticatorApi(CRUD):
    pass
